...
@auth.route('/change_password', methods=['GET', 'POST'])# we define the sign up path
def change_password(): # define the sign up function
...
def signup(): # define the sign up function
    if request.method=='GET': # If the request is GET we return the sign up page and forms
        ...
        new_user = User(name=name, company=company, email=email, username=username, password=generate_password_hash(password, method='scrypt')) #
